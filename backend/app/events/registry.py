...
class EventRegistry:
    ...
    def _register_default_events(self) -> None:
        ...
        defaults = [
            ...
            # Task 95: Action Transactions & Execution Governance Canonical Events
            EventRegistration("action.created", "v1", "Action transaction created and bound to target", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("action.preflight_started", "v1", "18-gate pre-flight validation initiated", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("action.preflight_passed", "v1", "All mandatory pre-flight validation gates passed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("action.preflight_failed", "v1", "Pre-flight validation failed on one or more gates", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("action.blocked", "v1", "Action execution blocked fail-closed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("action.authorization_verified", "v1", "Authorization revalidated by SecurityCenter", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("action.approval_verified", "v1", "Approval verified via ApprovalRegistry", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("action.awaiting_approval", "v1", "Action suspended awaiting formal authorization", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("action.resources_allocated", "v1", "Resource budget reserved in Resource Economy", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("action.ready", "v1", "Transaction ready for execution dispatch", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("action.execution_started", "v1", "Execution request dispatched to ToolExecutor", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("action.execution_progressed", "v1", "Execution progress telemetry received", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("action.execution_completed", "v1", "Tool execution completed successfully", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("action.execution_failed", "v1", "Tool execution encountered an error or exception", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("action.execution_cancelled", "v1", "Action execution cancelled by user or EmergencyStop", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("action.observation_recorded", "v1", "Empirical execution observation captured", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("action.verification_started", "v1", "Post-condition verification probes initiated", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("action.verification_passed", "v1", "All post-conditions verified against reality", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("action.verification_failed", "v1", "One or more post-conditions failed empirical check", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("action.verification_unknown", "v1", "Post-condition verification returned inconclusive state", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("action.partial_success", "v1", "Partial success achieved across multi-target execution", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("action.rollback_started", "v1", "Rollback compensation dispatched", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("action.rollback_completed", "v1", "Rollback compensation verified", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("action.recovery_started", "v1", "Recovery plan initiated for failed/unknown action", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("action.recovery_completed", "v1", "Recovery procedure completed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("action.outcome_confirmed", "v1", "Action outcome confirmed and recorded", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("action.outcome_unknown", "v1", "Action outcome could not be determined", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("action.expired", "v1", "Action transaction deadline elapsed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),

            # Task 96: Multi-Agent Collaboration & Swarm Orchestration Canonical Events
            EventRegistration("agent.created", "v1", "Agent instance created with bounded identity", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("agent.paused", "v1", "Agent execution suspended by supervisor", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("agent.resumed", "v1", "Agent execution resumed by supervisor", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("agent.timeout", "v1", "Agent execution deadline exceeded", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("agent.stalled", "v1", "Agent stalled or making no progress", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("agent.recovered", "v1", "Agent recovered by supervisor", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("agent.blocked", "v1", "Agent blocked awaiting dependency or approval", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("task.delegated", "v1", "Subtask delegated within authorized scope", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("task.ready", "v1", "Task dependencies resolved and runnable", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("task.blocked", "v1", "Task blocked by unmet dependencies", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("task.completed", "v1", "Task successfully completed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("task.failed", "v1", "Task failed execution", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("task.reassigned", "v1", "Task reassigned to substitute agent", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("task.cancelled", "v1", "Task cancelled due to prune or abort", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("agent.message_sent", "v1", "Typed agent message routed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("agent.result_received", "v1", "Agent completed work and submitted result", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("agent.result_validated", "v1", "Agent result verified and validated", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("agent.result_rejected", "v1", "Agent result rejected during validation", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("agent.conflict_detected", "v1", "Disagreement detected between agent claims", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("agent.consensus_reached", "v1", "Evidence-aware consensus established", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("agent.consensus_failed", "v1", "Consensus could not be reached, escalated", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("swarm.started", "v1", "Swarm collaboration session initiated", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("swarm.progressed", "v1", "Swarm subtask completed with progress", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("swarm.completed", "v1", "Swarm achieved validated final synthesis", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("swarm.failed", "v1", "Swarm execution aborted or failed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("swarm.degraded", "v1", "Swarm running in partial completion mode", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("swarm.cancelled", "v1", "Swarm cancelled or emergency stopped", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            # Task 97: Knowledge Graph Reasoning, Graph Memory & Structured Inference Canonical Events
            EventRegistration("graph.node_created", "v1", "Knowledge node created in reasoning graph", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("graph.node_updated", "v1", "Knowledge node attributes or status updated", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("graph.node_versioned", "v1", "Knowledge node version incremented", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("graph.node_merged", "v1", "Secondary node merged into canonical node", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("graph.node_invalidated", "v1", "Knowledge node invalidated or retracted", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("graph.edge_created", "v1", "Relationship edge established between nodes", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("graph.edge_updated", "v1", "Relationship edge confidence or validity updated", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("graph.edge_versioned", "v1", "Relationship edge version incremented", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("graph.edge_invalidated", "v1", "Relationship edge invalidated or expired", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("graph.edge_contradicted", "v1", "Relationship edge contradicted by conflicting proof", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("graph.inference_created", "v1", "Deterministic graph inference rule applied", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("graph.inference_invalidated", "v1", "Inferred edge invalidated due to parent invalidation", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("graph.snapshot_created", "v1", "Immutable graph state reference snapshot created", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("graph.diff_generated", "v1", "Comparative delta generated between graph snapshots", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("graph.impact_analyzed", "v1", "Downstream failure/change impact analysis completed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("graph.query_started", "v1", "Bounded graph traversal query initiated", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("graph.query_completed", "v1", "Graph traversal query finished successfully", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("graph.query_limited", "v1", "Graph query truncated due to depth/node safety limits", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("graph.query_failed", "v1", "Graph query execution failed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            # Task 98: World-State Reconstruction, State Estimation, Reality Synchronization & Drift Events
            EventRegistration("state.observation_received", "v1", "Empirical telemetry or probe observation ingested", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("state.reconstruction_started", "v1", "State estimation and reconstruction initiated", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("state.reconstruction_completed", "v1", "State reconstruction and estimation finished", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("state.changed", "v1", "Verified actual state entity attribute mutated", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("state.conflicted", "v1", "Dialectic disagreement detected across observation sources", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("state.reconciled", "v1", "Disagreement or state drift reconciled against evidence", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("state.stale", "v1", "Entity observation expired without fresh telemetry", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("state.invalidated", "v1", "Entity state retracted or invalidated due to contradiction", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("drift.detected", "v1", "Divergence between expected and actual state detected", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("drift.classified", "v1", "Detected drift classified by domain and severity", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("drift.attributed", "v1", "Drift causally linked to transaction or decision", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("drift.unattributed", "v1", "Drift occurred without identifiable causal actor", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("drift.resolved", "v1", "Drift remediated or expected convergence achieved", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("state.invariant_violation", "v1", "Domain invariant contract breach detected", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("state.revalidation_requested", "v1", "Downstream revalidation candidate scheduled", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("state.snapshot_created", "v1", "Immutable world-state snapshot captured", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("state.diff_generated", "v1", "Structural differential computed between state snapshots", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            # Task 99: Situational Awareness, Signal Fusion & Proactive Response Orchestration Events
            EventRegistration("situation.detected", "v1", "New operational situation detected from signal fusion", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("situation.forming", "v1", "Situation accumulating correlated signals and forming context", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("situation.activated", "v1", "Situation crossed threshold and activated for assessment", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("situation.escalated", "v1", "Situation severity or urgency escalated due to persistence or blast radius", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("situation.suppressed", "v1", "Situation suppressed due to duplicate, maintenance, or user preference", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("situation.merged", "v1", "Multiple related situations unified into single parent situation", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("situation.split", "v1", "Complex situation split into distinct independent incidents", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("situation.intervention_proposed", "v1", "Proactive response intervention candidate proposed to Decision Intelligence", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("situation.intervention_started", "v1", "Authorized action transaction initiated for situation remediation", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("situation.observing", "v1", "Post-action stabilization observation phase started", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("situation.stabilizing", "v1", "Situation exhibiting empirical convergence toward expected state", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("situation.resolved", "v1", "Situation verified resolved via empirical world-state observation", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("situation.expired", "v1", "Situation naturally expired without active escalation", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("situation.reopened", "v1", "Previously resolved or suppressed situation reopened due to recurrence", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("situation.unknown", "v1", "Situation marked unknown due to contradictory or missing observations", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("situation.pattern_detected", "v1", "Recurring historical situation pattern identified and recorded", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            # Task 100: Autonomous Mission Control, Long-Horizon Execution & Continuous Objective Orchestration Events
            EventRegistration("mission.created", "v1", "New autonomous mission instantiated", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("mission.activated", "v1", "Mission transitioned to active operational execution", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("mission.paused", "v1", "Mission paused due to operator hold, resource constraint, or safety halt", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("mission.resumed", "v1", "Mission revalidated and resumed after pause", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("mission.blocked", "v1", "Mission blocked by dependency, policy, or resource lock", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("mission.at_risk", "v1", "Mission health degraded to at_risk due to deadline or situation pressure", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("mission.plan_created", "v1", "Strategic plan version synthesized for mission", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("mission.plan_invalidated", "v1", "Active mission plan invalidated due to drift or assumption failure", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("mission.replanned", "v1", "Dynamic replanning cycle completed and new candidate plan adopted", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("mission.milestone_started", "v1", "Execution started on mission milestone", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("mission.milestone_completed", "v1", "Milestone empirically verified and marked completed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("mission.milestone_regressed", "v1", "Previously completed milestone regressed due to world state drift", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("mission.assumption_invalidated", "v1", "Explicit mission assumption failed and triggered cascading review", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("mission.dependency_changed", "v1", "Internal or external mission dependency status changed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("mission.awaiting_user", "v1", "Mission requires human feedback, clarification, or checkpoint approval", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("mission.awaiting_approval", "v1", "Mission intervention awaiting governance/security approval", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("mission.intervention_started", "v1", "ActionTransaction dispatched for milestone execution", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("mission.intervention_completed", "v1", "ActionTransaction completed execution", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("mission.progress_updated", "v1", "Multi-metric mission progress recalculated", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("mission.checkpoint_created", "v1", "Durable reproducible mission checkpoint captured", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("mission.degraded", "v1", "Mission degraded due to subsystem degradation or partial failures", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("mission.completed", "v1", "Mission and all constituent milestones empirically verified and completed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("mission.failed", "v1", "Mission failed due to unrecoverable blockers or budget exhaustion", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("mission.cancelled", "v1", "Mission explicitly cancelled by operator", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("mission.superseded", "v1", "Mission superseded by higher-priority strategic mandate", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("mission.unknown", "v1", "Mission placed in unknown state due to contradictory telemetry", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            # Uppercase aliases matching Section 46
            EventRegistration("MISSION_CREATED", "v1", "Mission created", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("MISSION_ACTIVATED", "v1", "Mission activated", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("MISSION_PAUSED", "v1", "Mission paused", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("MISSION_RESUMED", "v1", "Mission resumed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("MISSION_BLOCKED", "v1", "Mission blocked", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("MISSION_AT_RISK", "v1", "Mission at risk", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("MISSION_PLAN_CREATED", "v1", "Mission plan created", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("MISSION_PLAN_INVALIDATED", "v1", "Mission plan invalidated", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("MISSION_REPLANNED", "v1", "Mission replanned", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("MISSION_MILESTONE_STARTED", "v1", "Milestone started", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("MISSION_MILESTONE_COMPLETED", "v1", "Milestone completed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("MISSION_MILESTONE_REGRESSED", "v1", "Milestone regressed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("MISSION_ASSUMPTION_INVALIDATED", "v1", "Assumption invalidated", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("MISSION_DEPENDENCY_CHANGED", "v1", "Dependency changed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("MISSION_AWAITING_USER", "v1", "Mission awaiting user", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("MISSION_AWAITING_APPROVAL", "v1", "Mission awaiting approval", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("MISSION_INTERVENTION_STARTED", "v1", "Mission intervention started", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("MISSION_INTERVENTION_COMPLETED", "v1", "Mission intervention completed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("MISSION_PROGRESS_UPDATED", "v1", "Mission progress updated", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("MISSION_CHECKPOINT_CREATED", "v1", "Mission checkpoint created", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("MISSION_DEGRADED", "v1", "Mission degraded", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("MISSION_COMPLETED", "v1", "Mission completed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("MISSION_FAILED", "v1", "Mission failed", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
            EventRegistration("MISSION_CANCELLED", "v1", "Mission cancelled", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("MISSION_SUPERSEDED", "v1", "Mission superseded", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.INTERNAL_OPERATIONAL),
            EventRegistration("MISSION_UNKNOWN", "v1", "Mission unknown", ReplaySafety.NON_REPLAYABLE, EventSecurityClass.AUDIT_CRITICAL),
        ]
        for reg in defaults:
            self.register(reg)
