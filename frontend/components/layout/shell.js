        ...
        <div class="kairo-body">
          ...
          <nav class="kairo-sidebar" id="kairoSidebar" role="navigation" aria-label="Primary Navigation">
            ...
            <div class="nav-section">
              ...
              <button class="nav-item ${state.currentView === 'system-state' ? 'active' : ''}" onclick="window.kairoApp.navigateTo('system-state')">
                <span class="nav-icon">🕸️</span>
              ...
              <button class="nav-item ${state.currentView === 'execution' ? 'active' : ''}" onclick="window.kairoApp.navigateTo('execution')">
                <span class="nav-icon">⚡</span>
              ...
              <button class="nav-item ${['control-plane', 'control', 'operating-loop'].includes(state.currentView) ? 'active' : ''}" onclick="window.kairoApp.navigateTo('control-plane')">
                <span class="nav-icon">🎮</span>
